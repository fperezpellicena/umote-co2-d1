...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=adc/averaged_adc.c sht/sht.c xbee/digi_api.c xbee/digi_hw.c xbee/digi_send.c xbee/digi_serial.c xbee/digi_transmit_request.c xbee/payload.c xbee/digi_join.c xbee/digi_at_request.c main.c sensor_proxy.c interrupts.c pragmas.c network_proxy.c bsp.c co2-d1/co2-d1.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/adc/averaged_adc.p1 ${OBJECTDIR}/sht/sht.p1 ${OBJECTDIR}/xbee/digi_api.p1 ${OBJECTDIR}/xbee/digi_hw.p1 ${OBJECTDIR}/xbee/digi_send.p1 ${OBJECTDIR}/xbee/digi_serial.p1 ${OBJECTDIR}/xbee/digi_transmit_request.p1 ${OBJECTDIR}/xbee/payload.p1 ${OBJECTDIR}/xbee/digi_join.p1 ${OBJECTDIR}/xbee/digi_at_request.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/sensor_proxy.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/pragmas.p1 ${OBJECTDIR}/network_proxy.p1 ${OBJECTDIR}/bsp.p1 ${OBJECTDIR}/co2-d1/co2-d1.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/adc/averaged_adc.p1.d ${OBJECTDIR}/sht/sht.p1.d ${OBJECTDIR}/xbee/digi_api.p1.d ${OBJECTDIR}/xbee/digi_hw.p1.d ${OBJECTDIR}/xbee/digi_send.p1.d ${OBJECTDIR}/xbee/digi_serial.p1.d ${OBJECTDIR}/xbee/digi_transmit_request.p1.d ${OBJECTDIR}/xbee/payload.p1.d ${OBJECTDIR}/xbee/digi_join.p1.d ${OBJECTDIR}/xbee/digi_at_request.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/sensor_proxy.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/pragmas.p1.d ${OBJECTDIR}/network_proxy.p1.d ${OBJECTDIR}/bsp.p1.d ${OBJECTDIR}/co2-d1/co2-d1.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/adc/averaged_adc.p1 ${OBJECTDIR}/sht/sht.p1 ${OBJECTDIR}/xbee/digi_api.p1 ${OBJECTDIR}/xbee/digi_hw.p1 ${OBJECTDIR}/xbee/digi_send.p1 ${OBJECTDIR}/xbee/digi_serial.p1 ${OBJECTDIR}/xbee/digi_transmit_request.p1 ${OBJECTDIR}/xbee/payload.p1 ${OBJECTDIR}/xbee/digi_join.p1 ${OBJECTDIR}/xbee/digi_at_request.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/sensor_proxy.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/pragmas.p1 ${OBJECTDIR}/network_proxy.p1 ${OBJECTDIR}/bsp.p1 ${OBJECTDIR}/co2-d1/co2-d1.p1

# Source Files
SOURCEFILES=adc/averaged_adc.c sht/sht.c xbee/digi_api.c xbee/digi_hw.c xbee/digi_send.c xbee/digi_serial.c xbee/digi_transmit_request.c xbee/payload.c xbee/digi_join.c xbee/digi_at_request.c main.c sensor_proxy.c interrupts.c pragmas.c network_proxy.c bsp.c co2-d1/co2-d1.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"sht/include" -I"adc/include" -I"xbee/include" -I"co2-d1/include" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"sht/include" -I"adc/include" -I"xbee/include" -I"co2-d1/include" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/umote-co2-d1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
